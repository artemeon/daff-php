...
class HxClass {
	...
	public function __construct ($phpClassName) {
		#D:\tools\haxe\std/php/Boot.hx:667: characters 3-35
	...
	public function __call ($method, $args) {
		#D:\tools\haxe\std/php/Boot.hx:675: characters 3-111
		$callback = ((($this->phpClassName === "String" ? HxString::class : $this->phpClassName))??'null') . "::" . ($method??'null');
		#D:\tools\haxe\std/php/Boot.hx:676: characters 3-53
	...
	public function __get ($property) {
		#D:\tools\haxe\std/php/Boot.hx:684: lines 684-692
		if (\defined("" . ($this->phpClassName??'null') . "::" . ($property??'null'))) {
			#D:\tools\haxe\std/php/Boot.hx:685: characters 4-54
			return \constant("" . ($this->phpClassName??'null') . "::" . ($property??'null'));
		} else if (Boot::hasGetter($this->phpClassName, $property)) {
			#D:\tools\haxe\std/php/Boot.hx:687: characters 29-41
			$tmp = $this->phpClassName;
			#D:\tools\haxe\std/php/Boot.hx:687: characters 4-59
			...
			#D:\tools\haxe\std/php/Boot.hx:691: characters 33-45
			$tmp = $this->phpClassName;
			#D:\tools\haxe\std/php/Boot.hx:691: characters 4-56
			return $tmp::${$property};
		}
	}
	...
	public function __set ($property, $value) {
		#D:\tools\haxe\std/php/Boot.hx:700: lines 700-704
		if (Boot::hasSetter($this->phpClassName, $property)) {
			#D:\tools\haxe\std/php/Boot.hx:701: characters 22-34
			$tmp = $this->phpClassName;
			#D:\tools\haxe\std/php/Boot.hx:701: characters 4-59
			$tmp::{"set_" . ($property??'null')}($value);
		} else {
			#D:\tools\haxe\std/php/Boot.hx:703: characters 26-38
			$tmp = $this->phpClassName;
			#D:\tools\haxe\std/php/Boot.hx:703: characters 4-56
			$tmp::${$property} = $value;
		}
	}
}
