...
class HxClass {
	...
	public function __construct ($phpClassName) {
		#D:\tools\haxe\std/php/Boot.hx:665: characters 3-35
	...
	public function __call ($method, $args) {
		#D:\tools\haxe\std/php/Boot.hx:673: characters 3-111
		$callback = ((($this->phpClassName === "String" ? HxString::class : $this->phpClassName))??'null') . "::" . ($method??'null');
		#D:\tools\haxe\std/php/Boot.hx:674: characters 3-53
	...
	public function __get ($property) {
		#D:\tools\haxe\std/php/Boot.hx:682: lines 682-690
		if (\defined("" . ($this->phpClassName??'null') . "::" . ($property??'null'))) {
			#D:\tools\haxe\std/php/Boot.hx:683: characters 4-54
			return \constant("" . ($this->phpClassName??'null') . "::" . ($property??'null'));
		} else if (Boot::hasGetter($this->phpClassName, $property)) {
			#D:\tools\haxe\std/php/Boot.hx:685: characters 29-41
			$tmp = $this->phpClassName;
			#D:\tools\haxe\std/php/Boot.hx:685: characters 4-59
			return $tmp::{"get_" . ($property??'null')}();
		} else if (\method_exists($this->phpClassName, $property)) {
			#D:\tools\haxe\std/php/Boot.hx:687: characters 4-56
			return Boot::getStaticClosure($this->phpClassName, $property);
		} else {
			#D:\tools\haxe\std/php/Boot.hx:689: characters 33-45
			$tmp = $this->phpClassName;
			#D:\tools\haxe\std/php/Boot.hx:689: characters 4-56
			return $tmp::${$property};
		}
	}
	...
	public function __set ($property, $value) {
		#D:\tools\haxe\std/php/Boot.hx:698: lines 698-702
		if (Boot::hasSetter($this->phpClassName, $property)) {
			#D:\tools\haxe\std/php/Boot.hx:699: characters 22-34
			$tmp = $this->phpClassName;
			#D:\tools\haxe\std/php/Boot.hx:699: characters 4-59
			$tmp::{"set_" . ($property??'null')}($value);
		} else {
			#D:\tools\haxe\std/php/Boot.hx:701: characters 26-38
			$tmp = $this->phpClassName;
			#D:\tools\haxe\std/php/Boot.hx:701: characters 4-56
			$tmp::${$property} = $value;
		}
	}
}
