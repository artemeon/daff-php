...
class HxDynamicStr extends HxClosure {
	...
	public static function invoke ($str, $method, $args) {
		#D:\tools\haxe\std/php/Boot.hx:890: characters 3-34
		\array_unshift($args, $str);
		#D:\tools\haxe\std/php/Boot.hx:891: characters 3-69
	...
	public static function wrap ($value) {
		#D:\tools\haxe\std/php/Boot.hx:882: lines 882-886
		if (\is_string($value)) {
			#D:\tools\haxe\std/php/Boot.hx:883: characters 4-34
			return new HxDynamicStr($value);
		} else {
			#D:\tools\haxe\std/php/Boot.hx:885: characters 4-16
			return $value;
		}
	}
	...
	public function __construct ($str) {
		#D:\tools\haxe\std/php/Boot.hx:895: characters 3-19
	...
	public function __call ($method, $args) {
		#D:\tools\haxe\std/php/Boot.hx:911: characters 10-38
	...
	public function __get ($field) {
		#D:\tools\haxe\std/php/Boot.hx:900: lines 900-906
		if ($field === "length") {
			#D:\tools\haxe\std/php/Boot.hx:902: characters 5-36
			return mb_strlen($this->target);
		} else {
			#D:\tools\haxe\std/php/Boot.hx:904: characters 5-17
			$this->func = $field;
			#D:\tools\haxe\std/php/Boot.hx:905: characters 5-16
			return $this;
		}
	}
	...
	public function __invoke () {
		#D:\tools\haxe\std/php/Boot.hx:919: characters 10-54
		$str = $this->target;
		$method = $this->func;
		$args = \func_get_args();
		\array_unshift($args, $str);
	...
	public function callWith ($newThis, $args) {
		#D:\tools\haxe\std/php/Boot.hx:936: lines 936-938
		if ($newThis === null) {
			#D:\tools\haxe\std/php/Boot.hx:937: characters 4-20
			$newThis = $this->target;
		}
		#D:\tools\haxe\std/php/Boot.hx:939: characters 10-37
		$method = $this->func;
	...
	public function getCallback ($eThis = null) {
		#D:\tools\haxe\std/php/Boot.hx:926: lines 926-928
		if ($eThis === null) {
			#D:\tools\haxe\std/php/Boot.hx:927: characters 4-51
			return [$this, $this->func];
		}
		#D:\tools\haxe\std/php/Boot.hx:929: characters 3-69
