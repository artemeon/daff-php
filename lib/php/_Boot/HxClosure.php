...
class HxClosure {
	...
	public function __construct ($target, $func) {
		#D:\tools\haxe\std/php/Boot.hx:978: characters 3-23
		$this->target = $target;
		#D:\tools\haxe\std/php/Boot.hx:979: characters 3-19
		$this->func = $func;
		#D:\tools\haxe\std/php/Boot.hx:981: lines 981-983
		if (\is_null($target)) {
			#D:\tools\haxe\std/php/Boot.hx:982: characters 4-9
			throw Exception::thrown("Unable to create closure on `null`");
		}
		#D:\tools\haxe\std/php/Boot.hx:984: characters 3-104
	...
	public function __invoke () {
		#D:\tools\haxe\std/php/Boot.hx:992: characters 3-71
	...
	public function callWith ($newThis, $args) {
		#D:\tools\haxe\std/php/Boot.hx:1019: characters 3-65
	...
	public function equals ($closure) {
		#D:\tools\haxe\std/php/Boot.hx:1012: characters 10-60
		if (Boot::equal($this->target, $closure->target)) {
			#D:\tools\haxe\std/php/Boot.hx:1012: characters 39-59
	...
	public function getCallback ($eThis = null) {
		#D:\tools\haxe\std/php/Boot.hx:999: lines 999-1001
		if ($eThis === null) {
			#D:\tools\haxe\std/php/Boot.hx:1000: characters 4-18
			$eThis = $this->target;
		}
		#D:\tools\haxe\std/php/Boot.hx:1002: lines 1002-1004
		if (($eThis instanceof HxAnon)) {
			#D:\tools\haxe\std/php/Boot.hx:1003: characters 4-36
			return $eThis->{$this->func};
		}
		#D:\tools\haxe\std/php/Boot.hx:1005: characters 3-39
		return [$eThis, $this->func];
	}
}
