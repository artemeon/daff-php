...
class HxClosure {
	...
	public function __construct ($target, $func) {
		#D:\tools\haxe\std/php/Boot.hx:983: characters 3-23
		$this->target = $target;
		#D:\tools\haxe\std/php/Boot.hx:984: characters 3-19
		$this->func = $func;
		#D:\tools\haxe\std/php/Boot.hx:986: lines 986-988
		if (\is_null($target)) {
			#D:\tools\haxe\std/php/Boot.hx:987: characters 4-9
			throw Exception::thrown("Unable to create closure on `null`");
		}
		#D:\tools\haxe\std/php/Boot.hx:989: characters 3-104
	...
	public function __invoke () {
		#D:\tools\haxe\std/php/Boot.hx:997: characters 3-71
	...
	public function callWith ($newThis, $args) {
		#D:\tools\haxe\std/php/Boot.hx:1024: characters 3-65
	...
	public function equals ($closure) {
		#D:\tools\haxe\std/php/Boot.hx:1017: characters 10-60
		if (Boot::equal($this->target, $closure->target)) {
			#D:\tools\haxe\std/php/Boot.hx:1017: characters 39-59
	...
	public function getCallback ($eThis = null) {
		#D:\tools\haxe\std/php/Boot.hx:1004: lines 1004-1006
		if ($eThis === null) {
			#D:\tools\haxe\std/php/Boot.hx:1005: characters 4-18
			$eThis = $this->target;
		}
		#D:\tools\haxe\std/php/Boot.hx:1007: lines 1007-1009
		if (($eThis instanceof HxAnon)) {
			#D:\tools\haxe\std/php/Boot.hx:1008: characters 4-36
			return $eThis->{$this->func};
		}
		#D:\tools\haxe\std/php/Boot.hx:1010: characters 3-39
		return [$eThis, $this->func];
	}
}
