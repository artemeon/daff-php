...
class Std {
	...
	public static function parseFloat ($x) {
		#D:\tools\haxe\std/php/_std/Std.hx:79: characters 3-35
		$result = floatval($x);
		#D:\tools\haxe\std/php/_std/Std.hx:80: lines 80-81
		if (!Boot::equal($result, 0)) {
			#D:\tools\haxe\std/php/_std/Std.hx:81: characters 4-17
			return $result;
		}
		#D:\tools\haxe\std/php/_std/Std.hx:83: characters 3-22
		$x = ltrim($x);
		#D:\tools\haxe\std/php/_std/Std.hx:84: characters 3-53
		$firstCharIndex = (mb_substr($x, 0, 1) === "-" ? 1 : 0);
		#D:\tools\haxe\std/php/_std/Std.hx:85: characters 3-47
		$charCode = HxString::charCodeAt($x, $firstCharIndex);
		#D:\tools\haxe\std/php/_std/Std.hx:87: lines 87-89
		if ($charCode === 46) {
			#D:\tools\haxe\std/php/_std/Std.hx:88: characters 4-47
			$charCode = HxString::charCodeAt($x, $firstCharIndex + 1);
		}
		#D:\tools\haxe\std/php/_std/Std.hx:91: lines 91-95
		if (($charCode !== null) && ($charCode >= 48) && ($charCode <= 57)) {
			#D:\tools\haxe\std/php/_std/Std.hx:92: characters 4-14
			return 0.0;
		} else {
			#D:\tools\haxe\std/php/_std/Std.hx:94: characters 4-20
			return NAN;
		}
	}
	...
	public static function parseInt ($x) {
		#D:\tools\haxe\std/php/_std/Std.hx:55: characters 3-41
		$x = ltrim($x, " \x09\x0A\x0B\x0C\x0D");
		#D:\tools\haxe\std/php/_std/Std.hx:56: characters 3-44
		$digitsOnly = ltrim($x, "+-");
		#D:\tools\haxe\std/php/_std/Std.hx:57: lines 57-63
		if (str_starts_with($digitsOnly, "0x") || str_starts_with($digitsOnly, "0X")) {
			#D:\tools\haxe\std/php/_std/Std.hx:58: characters 4-37
			$val = intval($x, 16);
			#D:\tools\haxe\std/php/_std/Std.hx:60: lines 60-61
			if (($val === 0) && ((mb_strlen($digitsOnly) + 1) < mb_strlen($x))) {
				#D:\tools\haxe\std/php/_std/Std.hx:61: characters 5-16
				return null;
			}
			#D:\tools\haxe\std/php/_std/Std.hx:62: characters 4-14
			return $val;
		}
		#D:\tools\haxe\std/php/_std/Std.hx:65: characters 10-32
		$_g = stripos($x, "e");
		if ($_g !== false) {
			#D:\tools\haxe\std/php/_std/Std.hx:67: characters 9-13
			$ePos = $_g;
			#D:\tools\haxe\std/php/_std/Std.hx:67: characters 15-44
			$x = substr($x, 0, $ePos);
		}
		#D:\tools\haxe\std/php/_std/Std.hx:70: characters 3-36
		$val = intval($x, 10);
		#D:\tools\haxe\std/php/_std/Std.hx:73: lines 73-74
		if (($val === 0) && ((strspn($digitsOnly, "0123456789", 0, 1) === 0) || ((mb_strlen($digitsOnly) + 1) < mb_strlen($x)))) {
			#D:\tools\haxe\std/php/_std/Std.hx:74: characters 4-15
			return null;
		}
		#D:\tools\haxe\std/php/_std/Std.hx:75: characters 3-13
		return $val;
	}
	...
	public static function string ($s) {
		#D:\tools\haxe\std/php/_std/Std.hx:47: characters 3-27
