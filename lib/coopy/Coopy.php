...
/**
 *
 * This is the main entry-point to the library and the associatedven
 * command-line tool.
 *
 */
class Coopy {
	...
	public static function jsonify ($t) {
		#coopy/Coopy.hx:1198: characters 9-72
		$workbook = new StringMap();
		#coopy/Coopy.hx:1199: characters 9-73
		$sheet = new \Array_hx();
		#coopy/Coopy.hx:1200: characters 9-31
		$w = $t->get_width();
		#coopy/Coopy.hx:1201: characters 9-32
		$h = $t->get_height();
		#coopy/Coopy.hx:1202: characters 9-31
		$txt = "";
		#coopy/Coopy.hx:1203: characters 19-23
		$_g = 0;
		#coopy/Coopy.hx:1203: characters 23-24
		$_g1 = $h;
		#coopy/Coopy.hx:1203: lines 1203-1210
		while ($_g < $_g1) {
			#coopy/Coopy.hx:1203: characters 19-24
			$y = $_g++;
			#coopy/Coopy.hx:1204: characters 13-61
			$row = new \Array_hx();
			#coopy/Coopy.hx:1205: characters 23-27
			$_g2 = 0;
			#coopy/Coopy.hx:1205: characters 27-28
			$_g3 = $w;
			#coopy/Coopy.hx:1205: lines 1205-1208
			while ($_g2 < $_g3) {
				#coopy/Coopy.hx:1205: characters 23-28
				$x = $_g2++;
				#coopy/Coopy.hx:1206: characters 17-40
				$v = $t->getCell($x, $y);
				#coopy/Coopy.hx:1207: characters 17-28
				$row->arr[$row->length++] = $v;
			}
			#coopy/Coopy.hx:1209: characters 13-28
			$sheet->arr[$sheet->length++] = $row;
		}
		#coopy/Coopy.hx:1211: characters 9-36
		$workbook->data["sheet"] = $sheet;
		#coopy/Coopy.hx:1212: characters 9-24
		return $workbook;
	}
	...
	public static function show ($t) {
		...
		$w = $t->get_width();
		#coopy/Coopy.hx:1184: characters 9-32
		$h = $t->get_height();
		#coopy/Coopy.hx:1185: characters 9-31
		$txt = "";
		#coopy/Coopy.hx:1186: characters 19-23
		$_g = 0;
		#coopy/Coopy.hx:1186: characters 23-24
		$_g1 = $h;
		#coopy/Coopy.hx:1186: lines 1186-1192
		while ($_g < $_g1) {
			#coopy/Coopy.hx:1186: characters 19-24
			$y = $_g++;
			#coopy/Coopy.hx:1187: characters 23-27
			$_g2 = 0;
			#coopy/Coopy.hx:1187: characters 27-28
			$_g3 = $w;
			#coopy/Coopy.hx:1187: lines 1187-1190
			while ($_g2 < $_g3) {
				#coopy/Coopy.hx:1187: characters 23-28
				$x = $_g2++;
				#coopy/Coopy.hx:1188: characters 17-38
				$txt = ($txt??'null') . \Std::string($t->getCell($x, $y));
				#coopy/Coopy.hx:1189: characters 17-27
				$txt = ($txt??'null') . " ";
			}
			#coopy/Coopy.hx:1191: characters 13-24
			$txt = ($txt??'null') . "\x0A";
		}
		#coopy/Coopy.hx:1193: characters 9-14
		(Log::$trace)($txt, new _HxAnon_Coopy0("coopy/Coopy.hx", 1193, "coopy.Coopy", "show"));
	}
	...
	public static function tablify ($data) {
		#coopy/Coopy.hx:1225: characters 9-36
		if ($data === null) {
			#coopy/Coopy.hx:1225: characters 25-36
			return $data;
		}
		#coopy/Coopy.hx:1229: characters 9-63
		$get_cell_view = \Reflect::field($data, "getCellView");
		#coopy/Coopy.hx:1230: characters 9-45
		if ($get_cell_view !== null) {
			#coopy/Coopy.hx:1230: characters 34-45
			return $data;
		}
		#coopy/Coopy.hx:1242: characters 9-64
