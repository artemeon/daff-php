...
class DiffRender {
	...
	public function sampleCss () {
		...
		return ".highlighter .add { \x0D\x0A  background-color: #7fff7f;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter .remove { \x0D\x0A  background-color: #ff7f7f;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter td.modify { \x0D\x0A  background-color: #7f7fff;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter td.conflict { \x0D\x0A  background-color: #f00;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter .spec { \x0D\x0A  background-color: #aaa;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter .move { \x0D\x0A  background-color: #ffa;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter .null { \x0D\x0A  color: #888;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter table { \x0D\x0A  border-collapse:collapse;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter td, .highlighter th {\x0D\x0A  border: 1px solid #2D4068;\x0D\x0A  padding: 3px 7px 2px;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter th, .highlighter .header, .highlighter .meta {\x0D\x0A  background-color: #aaf;\x0D\x0A  font-weight: bold;\x0D\x0A  padding-bottom: 4px;\x0D\x0A  padding-top: 5px;\x0D\x0A  text-align:left;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter tr.header th {\x0D\x0A  border-bottom: 2px solid black;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter tr.index td, .highlighter .index, .highlighter tr.header th.index {\x0D\x0A  background-color: white;\x0D\x0A  border: none;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter .gap {\x0D\x0A  color: #888;\x0D\x0A}\x0D\x0A\x0D\x0A.highlighter td {\x0D\x0A  empty-cells: show;\x0D\x0A  white-space: pre-wrap;\x0D\x0A}\x0D\x0A";
	}
