...
final class EReg {
	...
	public function __construct ($r, $opt) {
		#D:\tools\haxe\std/php/_std/EReg.hx:37: characters 3-19
		$this->pattern = $r;
		#D:\tools\haxe\std/php/_std/EReg.hx:38: characters 3-45
		$this->options = str_replace("g", "", $opt);
		#D:\tools\haxe\std/php/_std/EReg.hx:39: characters 3-26
		$this->global = $this->options !== $opt;
		#D:\tools\haxe\std/php/_std/EReg.hx:40: characters 3-49
		$this->options = str_replace("u", "", $this->options);
		#D:\tools\haxe\std/php/_std/EReg.hx:41: characters 3-68
	...
	public function handlePregError () {
		#D:\tools\haxe\std/php/_std/EReg.hx:63: characters 3-36
		$e = preg_last_error();
		#D:\tools\haxe\std/php/_std/EReg.hx:64: lines 64-72
		if ($e === PREG_INTERNAL_ERROR) {
			#D:\tools\haxe\std/php/_std/EReg.hx:65: characters 4-9
			throw HaxeException::thrown("EReg: internal PCRE error");
		} else if ($e === PREG_BACKTRACK_LIMIT_ERROR) {
			#D:\tools\haxe\std/php/_std/EReg.hx:67: characters 4-9
			throw HaxeException::thrown("EReg: backtrack limit");
		} else if ($e === PREG_RECURSION_LIMIT_ERROR) {
			#D:\tools\haxe\std/php/_std/EReg.hx:69: characters 4-9
			throw HaxeException::thrown("EReg: recursion limit");
		} else if ($e === PREG_JIT_STACKLIMIT_ERROR) {
			#D:\tools\haxe\std/php/_std/EReg.hx:71: characters 4-9
	...
	public function match ($s) {
		#D:\tools\haxe\std/php/_std/EReg.hx:45: characters 10-29
