...
class Sys {
	...
	public static function args () {
		#D:\tools\haxe\std/php/_std/Sys.hx:41: lines 41-45
		if (array_key_exists("argv", $_SERVER)) {
			#D:\tools\haxe\std/php/_std/Sys.hx:42: characters 4-89
			return \Array_hx::wrap(array_slice($_SERVER["argv"], 1));
		} else {
			#D:\tools\haxe\std/php/_std/Sys.hx:44: characters 4-13
			return new \Array_hx();
		}
	}
	...
	public static function command ($cmd, $args = null) {
		#D:\tools\haxe\std/php/_std/Sys.hx:85: lines 85-95
		if ($args !== null) {
			#D:\tools\haxe\std/php/_std/Sys.hx:86: characters 12-24
			if (Sys::systemName() === "Windows") {
				#D:\tools\haxe\std/php/_std/Sys.hx:88: lines 88-91
				$_g = new \Array_hx();
				#D:\tools\haxe\std/php/_std/Sys.hx:89: lines 89-90
				$_g1 = 0;
				$_g2 = (\Array_hx::wrap([\StringTools::replace($cmd, "/", "\\")]))->concat($args);
				while ($_g1 < $_g2->length) {
					#D:\tools\haxe\std/php/_std/Sys.hx:89: characters 12-13
					$a = ($_g2->arr[$_g1] ?? null);
					#D:\tools\haxe\std/php/_std/Sys.hx:89: lines 89-90
					++$_g1;
					#D:\tools\haxe\std/php/_std/Sys.hx:90: characters 8-37
					$x = SysTools::quoteWinArg($a, true);
					$_g->arr[$_g->length++] = $x;
				}
				#D:\tools\haxe\std/php/_std/Sys.hx:88: characters 6-9
				$cmd = $_g->join(" ");
			} else {
				#D:\tools\haxe\std/php/_std/Sys.hx:93: characters 12-57
				...
				#D:\tools\haxe\std/php/_std/Sys.hx:93: characters 6-9
				$cmd = \Array_hx::wrap($result)->join(" ");
			}
		}
		#D:\tools\haxe\std/php/_std/Sys.hx:96: characters 3-30
		$result = Boot::deref(0);
		#D:\tools\haxe\std/php/_std/Sys.hx:97: characters 3-29
		system($cmd, $result);
		#D:\tools\haxe\std/php/_std/Sys.hx:98: characters 3-16
		return $result;
	}
	...
	public static function getEnv ($s) {
		#D:\tools\haxe\std/php/_std/Sys.hx:49: characters 3-32
		$value = getenv($s);
		#D:\tools\haxe\std/php/_std/Sys.hx:50: characters 10-39
		if ($value === false) {
			#D:\tools\haxe\std/php/_std/Sys.hx:50: characters 27-31
			return null;
		} else {
			#D:\tools\haxe\std/php/_std/Sys.hx:50: characters 34-39
			return $value;
		}
	}
	...
	public static function stderr () {
		#D:\tools\haxe\std/php/_std/Sys.hx:143: characters 3-87
		$p = (defined("STDERR") ? STDERR : fopen("php://stderr", "w"));
		#D:\tools\haxe\std/php/_std/Sys.hx:144: characters 3-43
	...
	public static function stdout () {
		#D:\tools\haxe\std/php/_std/Sys.hx:138: characters 3-87
		$p = (defined("STDOUT") ? STDOUT : fopen("php://stdout", "w"));
		#D:\tools\haxe\std/php/_std/Sys.hx:139: characters 3-43
		return new FileOutput($p);
	}
	...
	public static function systemName () {
		#D:\tools\haxe\std/php/_std/Sys.hx:79: characters 3-33
		$s = php_uname("s");
		#D:\tools\haxe\std/php/_std/Sys.hx:80: characters 3-26
		$p = HxString::indexOf($s, " ");
		#D:\tools\haxe\std/php/_std/Sys.hx:81: characters 10-39
		if ($p >= 0) {
			#D:\tools\haxe\std/php/_std/Sys.hx:81: characters 20-34
			return mb_substr($s, 0, $p);
		} else {
			#D:\tools\haxe\std/php/_std/Sys.hx:81: characters 37-38
			return $s;
		}
	}
}
